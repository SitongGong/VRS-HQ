...
from dataset.rvos_eval_dataset import RVOSEvalDataset
...
def parse_args(args):
    ...
    parser.add_argument(
        "--version", default="/18515601223/chat_univi"        # your path to chat-univi
    )
    ...
    parser.add_argument(
        "--vision-tower", default="/18515601223/openai/clip-vit-large-patch14", type=str       # path to clip
    )
    ...
    parser.add_argument("--log_base_dir", default="/18515601223/segment-anything-2/runs", type=str)         # path to save results and checkpoints
    parser.add_argument("--exp_name", default="VRSHQ", type=str)
    ...
    parser.add_argument("--vision_pretrained", default="/18515601223/segment-anything-2/checkpoints/sam2_hiera_large.pt", type=str)     # path to sam2 checkpoint
...
def main(args):
    ...
    model_args = {
        "train_memory_modules": args.train_memory_modules, 
    ...
    model_args_from_pt = AutoConfig.from_pretrained(pretrained_model_name_or_path=args.version)
