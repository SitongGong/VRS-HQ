...
class RVOSEvalDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        clip_vision_tower       : str  = "/18515601223/openai/clip-vit-large-patch14-336", 
        device                  : str  = "cuda"
    ):
...
if __name__ == "__main__":
    image_root = '/18515601223/VISA-main/dataset/rvos_root'
    json_file = '/18515601223/VISA-main/dataset/rvos_root/ReVOS/meta_expressions_valid__llamavid.json'
    dataset_name = 'revos_valid'
    output_dir = '/18515601223/segment-anything-2/runs/val_7b'
