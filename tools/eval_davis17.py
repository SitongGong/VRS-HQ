...
if __name__ == '__main__':
    ...
    parser.add_argument("--mevis_pred_path", type=str, default='/18515601223/Seg-Zero/refvos_results/keyframe_sam_sft_mod_davis_500/Annotations')
    parser.add_argument("--mevis_exp_path", type=str, default="/18515601223/dataset/rvos_root/davis17/meta_expressions/valid/meta_expressions.json")
    parser.add_argument("--mevis_mask_path", type=str, default="/18515601223/dataset/rvos_root/davis17/valid/mask_dict.pkl")
