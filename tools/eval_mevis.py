...
if __name__ == '__main__':
    ...
    parser.add_argument("--mevis_pred_path", type=str, default='/18515601223/segment-anything-2/rvos_results/val_7b_sam2_mevis_multiseg_phi3/mevis_test/Annotations')
