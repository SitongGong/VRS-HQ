...
def main():
    ...
    parser.add_argument('--dir', default='/18515601223/Seg-Zero/refvos_results/keyframe_sam_sft_mod_mevis_500/Annotations', help='path to the directory')
    parser.add_argument('--out', default='/18515601223/Seg-Zero/refvos_results/keyframe_sam_sft_mod_mevis_500/Annotations.zip', help='path to the output zip file')
