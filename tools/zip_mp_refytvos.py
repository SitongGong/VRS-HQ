...
def main():
    ...
    parser.add_argument('--dir', default='/18515601223/Seg-Zero/refvos_results/keyframe_sam_sft_mod_refytvos_7b_200_sam2_1/Annotations', help='path to the directory')
    parser.add_argument('--out', default='/18515601223/Seg-Zero/refvos_results/keyframe_sam_sft_mod_refytvos_7b_200_sam2_1/Annotations.zip', help='path to the output zip file')
    parser.add_argument('--rm', action='store_true', help='remove the directory after zipping', default=True)
